                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="UserConfirmAction.action" method="post" class="registration-form">
				                    	<div class="form-group">
				                    		<label class="sr-only" for="form-last-name">ID1</label>
				                        	<input type="text" name="lastName" placeholder="ID" class="form-last-name form-control" id="form-last-name">
				                        </div>
 				                        <div class="form-group">
				                        	<label class="sr-only" for="form-first-name">パスワード1</label>
